...
func TestParsingDuration(t *testing.T) {
	...
	var tests = []struct {
		...
		{"1hh", 0, 7, fmt.Errorf("Unknown duration format for 1hh")},
		{"1dd", 0, 7, fmt.Errorf("Unknown duration format for 1dd")},
		{"1dd", 0, 7, fmt.Errorf("Unknown duration format for 1dd")},
		{"1hd", 0, 7, fmt.Errorf("Unknown duration format for 1hd")},
		{"1 sm", 0, 7, fmt.Errorf("Unknown duration format for 1 sm")},
		{"1sm", 0, 7, fmt.Errorf("Unknown duration format for 1sm")},
		{"1n", 0, 7, fmt.Errorf("Unknown duration format for 1n")},
		{"-1s", 0, 7, fmt.Errorf("Unknown duration format for -1s")},
	}
